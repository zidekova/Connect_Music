...
//        },
        ...
        PlaylistDetailsBody(
            playlistDetailsUiState = uiState.value,
            onDelete = {
...
private fun PlaylistDetailsBody(
    ...
    Column(
        ...
        PlaylistDetails(
            playlist = playlistDetailsUiState.playlistDetails.toPlaylist(), modifier = Modifier.fillMaxWidth()
        )
        OutlinedButton(
    ...
    Card(
        ...
        Column(
            ...
            PlaylistDetailsRow(
                ...
                playlistDetail = playlist.name_playlist,
...
@Composable
private fun PlaylistDetailsRow(
    @StringRes labelResID: Int, playlistDetail: String, modifier: Modifier = Modifier
) {
    Row(modifier = modifier) {
        Text(text = stringResource(labelResID))
        Spacer(modifier = Modifier.weight(1f))
        Text(text = playlistDetail, fontWeight = FontWeight.Bold)
    }
}
